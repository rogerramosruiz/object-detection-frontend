<script>
    ...
    <Dropzone on:drop={handleFilesSelect} accept={type+'/*'} maxFiles='1'>
      <div class="w-full h-full rounded flex justify-center items-center ">
        <svg version="1.1" class="h-8 mr-2 fill-blue-600" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
      ...
      <span class="block text-blue-400">Arrastre su {type} aqui o presione aqui</span>
    </div>
